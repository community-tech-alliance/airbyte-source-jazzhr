...
import pytest
from source_jazzhr.source import jazzhrStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(jazzhrStream, "path", "v0/example_endpoint")
    mocker.patch.object(jazzhrStream, "primary_key", "test_primary_key")
    mocker.patch.object(jazzhrStream, "__abstractmethods__", set())
